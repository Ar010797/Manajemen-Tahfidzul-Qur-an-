        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="space-y-1">
                <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Nama Instansi (SD / Umum)</label>
                <input 
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Alamat Lengkap (SD / Umum)</label>
                <textarea 
              ...
              <div className="pt-4 border-t border-stone-200 space-y-6">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Nama Instansi (Tsanawiyah / MTS)</label>
                  <input 
                    type="text"
                    className="w-full bg-stone-50 border border-stone-200 rounded-xl px-4 py-3"
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Alamat Lengkap (Tsanawiyah / MTS)</label>
                  <textarea 
                    className="w-full bg-stone-50 border border-stone-200 rounded-xl px-4 py-3 min-h-[100px]"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-stone-100">
            <div className="space-y-4">
              <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Logo Lembaga (Kop Surat SD/Umum)</label>
            ...
            <div className="space-y-4">
              <label className="text-xs font-bold text-stone-400 uppercase tracking-wider ml-1">Logo Lembaga (Kop Surat Tsanawiyah/MTS)</label>
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 bg-white border-2 border-dashed border-stone-200 rounded-2xl flex items-center justify-center overflow-hidden">
                ...
                <input 
                  type="file"
                  accept="image/*"
                  onChange={e => handleFileUpload(e, 'logo_mts')}
                  className={cn(
                    "text-sm text-stone-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold cursor-pointer",
                    `file:${theme.lightBg} file:${theme.lightText} hover:file:opacity-80`
                  )}
