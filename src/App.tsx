...
export default function App() {
  ...
  if (isLoading) return <div className="h-screen w-screen flex items-center justify-center bg-stone-50">Loading...</div>;
  ...
  return (
    <div className="flex h-screen bg-[#FDFCFB] text-stone-800 font-sans overflow-hidden relative">
      {/* Mobile Overlay */}
      {isSidebarOpen && (
        <div 
